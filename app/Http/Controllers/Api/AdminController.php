...
class AdminController extends Controller
{
    ...
    public function downloadExamImportTemplate()
    {
        $lines = [
            ...
            '考试时长(分钟)：必填。考试时间限制（分钟）。',
            '及格分数：必填。0-100 之间的数字。',
            '题型：必填。single（单选）、multiple（多选）、truefalse（判断）、short_answer（简答）、fill_blank（填空）。',
            '题目内容：必填。题目的文字内容。填空题用（）标记空位。',
            '选项：选填。单选/多选/判断题必填，格式：A.选项1|B.选项2|C.选项3|D.选项4',
            '正确答案：单选填字母（如A），多选填逗号分隔（如A,B,D），判断填A(对)或B(错)，简答填参考答案（可选），填空填逗号分隔答案（如前锁,后锁）。',
            '分值：必填。该题分值，同一考试所有题目分值之和不能超过100。',
            '题目关联课程ID：选填。答错时跳转的课程ID。',
            '排序：选填。题目显示顺序，默认0。',
            '',
            '=================== 示例数据 ===================',
            '考试名称,关联课程ID,考试时长(分钟),及格分数,题型,题目内容,选项,正确答案,分值,题目关联课程ID,排序',
            '产品知识考试,,60,60,single,公司的核心价值观是什么？,A.客户第一|B.创新驱动|C.团队协作|D.以上都是,D,10,,1',
            '产品知识考试,,60,60,multiple,以下哪些是公司的产品线？,A.产品A|B.产品B|C.产品C|D.产品D,"A,B,C",10,,2',
            '产品知识考试,,60,60,truefalse,公司成立于2020年。,A.正确|B.错误,B,10,,3',
            '产品知识考试,,60,60,short_answer,请简述公司的愿景。,,成为行业领导者,20,,4',
            '产品知识考试,,60,60,fill_blank,请区分以下连接器哪些是前锁板（）（）。,,"前锁,后锁",20,,5',
